...
В desktop-приложении откройте страницу «Настройки» и сохраните ключ в форме. Он попадёт в Keychain на macOS или системное хранилище Windows. API возвращает только состояние «настроен/не настроен» и никогда не возвращает сам ключ. Ключ не попадает в HTML, JavaScript, SQLite, логи, установщик или Git.
